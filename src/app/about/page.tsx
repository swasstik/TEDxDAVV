...
export default function Page() {
  ...
  return (
         <div>
            ...
            <p className='my-3'>At a TED conference, the worlds leading thinkers and doers are asked to give the talk of their lives in 18 minutes or less. TED speakers have included Roger Ebert, Sheryl Sandberg, Bill Gates, Elizabeth Gilbert, Benoit Mandelbrot, Philippe Starck, Ngozi Okonjo-Iweala, Brian Greene, Isabel Allende and former UK Prime Minister Gordon Brown. Three major TED events are held each year: The TED Conference takes place every spring in Vancouver, Canada, simultaneous with TEDActive, in Whistler, BC; and the TEDGlobal Conference takes place each summer in Edinburgh, Scotland.</p>
            ...
            <p className='my-3'>For information about TEDs upcoming conferences, visit <a href='http://www.ted.com/registration'><span className='text-red-400'>http://www.ted.com/registration</span></a></p>
            <div className='border-b-8 w-60 border-red-500'></div>
