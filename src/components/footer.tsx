...
export default function Footer() {
  return (
        ...
        <div className="bg-white mx-auto w-full max-w-screen-xl pt-0 p-4 pb-6 lg:pb-8">
      <hr className="mb-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:mb-8" />
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Heartfulness</a>. All Rights Reserved.
          </span>
